...
const KEYS = [
  ...
  "CRABBOX_CLOUDFLARE_RUNNER_INSTANCE_TYPE",
  "CRABBOX_CLOUDFLARE_RUNNER_WORKDIR",
  "CRABBOX_CLOUDFLARE_RUNNER_TTL_SECONDS",
  "CRABBOX_CLOUDFLARE_RUNNER_IDLE_SECONDS",
  ...
  "LOBSTERFLEET_LOCAL_SANDBOX_BACKUPS",
  "OPENAI_API_KEY",
  "OPENAI_BASE_URL",
  "OPENAI_ORG_ID",
  "R2_ACCESS_KEY_ID",
